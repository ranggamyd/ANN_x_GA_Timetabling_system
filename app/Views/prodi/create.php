                    ...
                    <form action="/prodi/store" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group <?= $validation->hasError('kode_prodi') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input type="text" name="kode_prodi" value="<?= set_value('kode_prodi') ?>" class="form-control" id="kode_prodi" autofocus required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group <?= $validation->hasError('nama_prodi') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <input type="text" name="nama_prodi" value="<?= set_value('nama_prodi') ?>" class="form-control" id="nama_prodi" required>
                                ...
                                <div class="col">
                                    <div class="form-group <?= $validation->hasError('fakultas') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <select name="fakultas" class="form-control <?= $validation->hasError('fakultas') ? 'is-invalid' : '' ?>" id="fakultas">
                                            <!-- <option hidden></option> -->
                                            <?php foreach ($fakultas as $item) : ?>
                                                <option value="<?= $item ?>" <?= set_select('fakultas', $item) ?> <?= $item != 'Teknik' ? 'disabled' : '' ?>><?= $item ?></option>
                                            <?php endforeach ?>
                                        </select>
