        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <form action="/ruang/update/<?= $ruang['id_ruang'] ?>" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group <?= $validation->hasError('kode_ruang') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input type="text" name="kode_ruang" value="<?= set_value('kode_ruang', $ruang['kode_ruang']) ?>" class="form-control" id="kode_ruang" autofocus required>
                            ...
                            <div class="form-group <?= $validation->hasError('nama_ruang') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input type="text" name="nama_ruang" value="<?= set_value('nama_ruang', $ruang['nama_ruang']) ?>" class="form-control" id="nama_ruang" required>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group <?= $validation->hasError('kapasitas') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <input type="number" name="kapasitas" value="<?= set_value('kapasitas', $ruang['kapasitas']) ?>" class="form-control" id="kapasitas" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="selectgroup selectgroup-pills">
                                            <?php foreach ($prodi as $item) : ?>
                                                <?php $ruangProdi = model('RuangProdiModel')->where(['id_ruang' => $ruang['id_ruang'], 'id_prodi' => $item['id_prodi']])->first() ?>

                                                <label class="selectgroup-item">
                                                    <input type="checkbox" name="id_prodi[]" value="<?= $item['id_prodi'] ?>" class="selectgroup-input" <?= set_checkbox('id_prodi', $item['id_prodi'], $ruangProdi ? $ruangProdi['id_prodi'] === $item['id_prodi'] : false) ?>>
