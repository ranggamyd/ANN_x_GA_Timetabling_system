                    ...
                    <form action="/users/update/<?= $users['id_user'] ?>" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group <?= $validation->hasError('username') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input disabled type="text" name="username" value="<?= set_value('username', $users['username']) ?>" class="form-control" id="username" autofocus required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group <?= $validation->hasError('password') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <input disabled type="password" name="password" value="<?= set_value('password') ?>" class="form-control" id="password" required>
                                ...
                                <div class="col">
                                    <div class="form-group <?= $validation->hasError('password_conf') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <input disabled type="password" name="password_conf" value="<?= set_value('password_conf') ?>" class="form-control" id="password_conf" required>
                            ...
                            <div class="form-group <?= $validation->hasError('avatar') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input disabled type="file" name="avatar" value="<?= set_value('avatar') ?>" class="form-control" id="avatar">
