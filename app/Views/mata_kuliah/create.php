                    ...
                    <form action="/mata_kuliah/store" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group <?= $validation->hasError('kode_mata_kuliah') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input type="text" name="kode_mata_kuliah" value="<?= set_value('kode_mata_kuliah') ?>" class="form-control" id="kode_mata_kuliah" autofocus required>
                            ...
                            <div class="form-group <?= $validation->hasError('nama_mata_kuliah') ? 'has-error has-feedback' : '' ?>">
                                ...
                                <input type="text" name="nama_mata_kuliah" value="<?= set_value('nama_mata_kuliah') ?>" class="form-control <?= $validation->hasError('nama_mata_kuliah') ? 'is-invalid' : '' ?>" id="nama_mata_kuliah" required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group <?= $validation->hasError('sks') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <input type="number" name="sks" value="<?= set_value('sks') ?>" min="1" max="8" class="form-control <?= $validation->hasError('sks') ? 'is-invalid' : '' ?>" id="sks" required>
                                ...
                                <div class="col">
                                    <div class="form-group <?= $validation->hasError('semester') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <input type="number" name="semester" value="<?= set_value('semester') ?>" min="1" max="8" class="form-control <?= $validation->hasError('semester') ? 'is-invalid' : '' ?>" id="semester" required>
                                ...
                                <div class="col">
                                    <div class="form-check <?= $validation->hasError('sifat') ? 'has-error has-feedback' : '' ?>">
                                        ...
                                        <label class="form-radio-label">
                                            <input type="radio" name="sifat" class="form-radio-input" value="Wajib" <?= set_radio('sifat', 'Wajib', true) ?>>
                                            <span class="form-radio-sign">Wajib</span>
                                        </label>
                                        <label class="form-radio-label">
                                            <input type="radio" name="sifat" class="form-radio-input" value="Pilihan" <?= set_radio('sifat', 'Pilihan') ?>>
